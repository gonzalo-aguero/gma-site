...
if($var == 1){
    ...
    $msg = "Hola, me gustaría que me pasaran presupuesto para un Sitio web.\n----------------------\nComentarios, detalles o especificaciones:\n";

}else if($var == 2){

    $msg = "Hola, me gustaría que me pasaran presupuesto para una Tienda online.\n----------------------\nComentarios, detalles o especificaciones:\n";

}else if($var == 3){

    $msg = "Hola, quisiera saber más sobre el Gestor de contenido.";
...
<head>
    ...
    <title>GMA desarrollo web - Contacto</title>
        ...
        <nav>
            ...
            <div id="div-menu" class="animate__animated animate__fadeIn">
                ...
                <ul class="animate__animated animate__fadeInRightBig">
                    ...
                    <a class="" href="https://gmadesarrolloweb.ml/nosotros.php">Nosotros</a>

                    <a class="" href="https://gmadesarrolloweb.ml/servicios.php">Servicios</a>

                    <a class="" href="https://gmadesarrolloweb.ml/contacto.php" style="color:#000000; font-weight: bold">Contacto</a>
